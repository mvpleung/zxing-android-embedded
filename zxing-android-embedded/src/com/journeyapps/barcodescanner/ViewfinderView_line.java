 ...
 */
public class ViewfinderView_line extends View {
    protected static final String TAG = ViewfinderView_line.class.getSimpleName();
    ...
    public ViewfinderView_line(Context context, AttributeSet attrs) {
        super(context, attrs);
